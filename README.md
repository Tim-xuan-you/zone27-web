...
|---|---|---|---|
| FREE | NT$ 0 | 無限 | — |
| BLACK CARD | NT$ 500 / 31 天 | 無限 | 10% |
| **FOUNDERS 27** | **NT$ 2,700 / 365 天** | **無限(前 270 拿創始編號徽章)** | **5%(floor)** |

引擎永遠免費。收款全手動銀行轉帳 · 0 自動續扣(/integrity #13)。
拒絕:AdMob 廣告、抽賭注傭、auto-renewal。創作者賣分析 · 平台抽 5-10%(會員費 + 內容抽傭)。
