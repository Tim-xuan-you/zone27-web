...
const rawMatches: Match[] = [
  ...
  //     Tim 6/27 補了新莊投手表 → winRate 用真值重算(原 62 下修 58)。 表面 ERA 看似富邦碾壓(李東洛 1.56 vs
  //     陳克羿 3.00),但拆內容 = 假象:李東洛 K9 僅 4.8 / WHIP 1.14、且生涯 2024/25 ERA 4.23/4.52 → 1.56 是運氣
  //     壓低(ERA 遠低於 WHIP 該有水準)、會回歸;陳克羿 2026 K9 9.0 / WHIP 1.06 / BAA .222 內容其實更好(只是
  //     18 IP 樣本小)。 真實先發對位幾乎五五 → 富邦優勢回到「隊強 + 主場」這兩項,不是先發 → 富邦 58 / 樂天 42 ·
  //     conf 52(別被李東洛 1.56 騙 · 隊強+主場仍偏富邦但非大熱)。(格式 home : away = 富邦 : 樂天)
  {
    id: "cpbl-260627-01",
    league: "CPBL",
    date: "2026 · 06 · 27  ·  星期六",
  ...
  },
  {
    ...
    home: {
      ...
      pitcher: {
        name: "李東洛",
        era: "1.56", // 2026 官網累計成績表(Tim 6/27 截圖)· 63.1 IP(11 先發 · 樣本厚)· 🔴 ERA 遠低於內容 = 運氣壓低、會回歸(生涯 2024/25 ERA 4.23/4.52)
        k9: "4.8", // 34 K / 63.1 IP × 9 · 低三振
        whip: "1.14", // 官網每局被上壘率 1.136(50 H + 22 BB / 63.1 IP)
        bb9: "3.1", // 22 BB / 63.1 IP × 9 · 控球偏散
        hr9: "0.14", // 1 HR / 63.1 IP × 9 · 極少被轟
      },
    ...
    away: {
      ...
      pitcher: {
        name: "陳克羿",
        era: "3.00", // 2026 官網累計成績表(Tim 6/27 截圖)· 18 IP(3 先發 · 樣本小)· 內容紮實 · 生涯 2024/25 4.39/3.68(今年明顯進步)
        k9: "9.0", // 18 K / 18 IP × 9 · 三振率佳
        whip: "1.06", // 官網每局被上壘率 1.055(14 H + 5 BB / 18 IP)· 比李東洛還好
        bb9: "2.5", // 5 BB / 18 IP × 9
        hr9: "0.00", // 0 HR / 18 IP(生涯約 0.2 · winRate 已壓不偏袒)
      },
      recent: ["L", "W", "L", "L", "L"], // placeholder · 樂天 21-32-2(.396 後段)
      winRate: 42,
    },
    topScores: [
      // 先發其實五五波(別被李東洛 1.56 騙)· 富邦隊強+主場微 lean · 中分(格式 home : away = 富邦 : 樂天)
  ...
  //   投手值由官網累計成績表(IP/K/BB/HR)換算 · 標 estimate(自 Tim 截圖手抄)· winRate 手 curate
  //   (ERA+控球+主場+隊伍 W-L · 接近五五波就誠實低 conviction)· 天氣不建模(/audit S02)。
  //   🚫 第三場(樂天 vs 統一)不開:樂天先發 榊原元稀 是生涯一軍首登板 · 零資料(出賽 0 / 0 IP / ERA 0.00)。
  //      要開只剩兩條路、兩條都犯規:① 捏造他的投手數據(違反「不假裝」)② 照填 0.00 ERA(卡面把沒投過球
  //      的新人顯示成無敵投手 = 誤導)。 先發是 winRate 一半、樂天又是主隊 → 半場資料零到只能掰 = 這條線
  //      不是「算出來的」是「掰出來的」。 賭場照開,我們只開算得出的(同 /soccer「賭場什麼都敢開,我們只開
  //      算得出的」· 同 /table「無模型就說無模型」紀律)。 等他真投幾場有真資料,再上這種對戰。
  //   洲際 · 富邦(阿部雄大 away)vs 中信(伍立辰 home)· W-L 富邦 30-24-0(.556)/ 中信 18-34-2(.346 墊底)。
  //     富邦雙重優勢:better team + 先發明顯更壓制 —— 阿部雄大 2026 ERA 3.31 / BAA .187 / WHIP 0.96 / K9 7.6
  //     vs 中信伍立辰 2026 ERA 6.39 / BAA .300 / WHIP 1.82 / BB9 5.7(控球野、正挨打)· 僅 12.2 IP 小樣本。
  //     抵銷:中信主場 + 伍立辰小樣本回歸空間(2025 後援 2.84)→ 富邦清楚 favored 但不裝神準 · 富邦 62 / 中信 38 · conf 57。
  //   澄清湖 · 味全(梅賽鎯 away)vs 台鋼(江承諺 home)· W-L 味全 38-18-0(.679 全聯盟最強)/ 台鋼 29-27-1(.518)。
  //     全聯盟最強隊 + 王牌出戰:梅賽鎯 2026 ERA 1.59 / WHIP 1.01 / BB9 1.5(頂級控球)· 8-1。 台鋼主場 +
  //     江承諺 2026 ERA 2.24(低三振 pitch-to-contact · WHIP 1.22)是真能投 → 壓住不喊更高;梅賽鎯 1.59 有
  //     些微回歸風險(2025 為 2.57)→ 味全 63 / 台鋼 37 · conf 57。
  {
    id: "cpbl-260623-01",
    league: "CPBL",
    date: "2026 · 06 · 23  ·  星期二",
    ...
    home: {
      ...
      pitcher: {
        name: "伍立辰",
        era: "6.39", // estimate · 2026 官網累計成績表(Tim 截圖手抄)· 12.2 IP 小樣本(2025 後援 2.84)· 正挨打
        k9: "5.0", // estimate · 7 K / 12.2 IP × 9
        whip: "1.82", // estimate · 官網每局被上壘率 1.815(15 H + 8 BB / 12.2 IP)
        bb9: "5.7", // estimate · 8 BB / 12.2 IP × 9 · 控球野
        hr9: "0.00", // estimate · 0 HR / 12.2 IP
      },
      recent: ["L", "L", "W", "L", "L"], // placeholder · 中信 18-34-2(.346 墊底)
      winRate: 38,
    },
    away: {
      name: "富邦悍將",
      ...
      pitcher: {
        name: "阿部雄大",
        era: "3.31", // estimate · 2026 官網累計成績表(Tim 截圖手抄)· 35.1 IP(6 先發)· BAA .187 壓制佳
        k9: "7.6", // estimate · 30 K / 35.1 IP × 9
        whip: "0.96", // estimate · 官網每局被上壘率 0.962(23 H + 11 BB / 35.1 IP)· 頂級
        bb9: "2.8", // estimate · 11 BB / 35.1 IP × 9
        hr9: "0.51", // estimate · 2 HR / 35.1 IP × 9
      },
      recent: ["W", "L", "W", "W", "L"], // placeholder · 富邦 30-24-0(.556)
      winRate: 62,
    },
    topScores: [
      // 富邦先發壓制 + 中信先發挨打 → 富邦 lean、中信得分受限(格式 home : away = 中信 : 富邦)
      { score: "2 : 4", probability: 9.0 },
      { score: "1 : 3", probability: 8.5 },
      { score: "2 : 5", probability: 8.0 },
      { score: "3 : 5", probability: 7.5 },
  ...
  },
  {
    ...
    home: {
      ...
      pitcher: {
        name: "江承諺",
        era: "2.24", // estimate · 2026 官網累計成績表(Tim 截圖手抄)· 52.1 IP(9 先發)· 低三振 pitch-to-contact
        k9: "3.6", // estimate · 21 K / 52.1 IP × 9
        whip: "1.22", // estimate · 官網每局被上壘率 1.222(49 H + 15 BB / 52.1 IP)
        bb9: "2.6", // estimate · 15 BB / 52.1 IP × 9
        hr9: "0.17", // estimate · 1 HR / 52.1 IP × 9
      },
      recent: ["W", "L", "W", "L", "W"], // placeholder · 台鋼 29-27-1(.518)
      winRate: 37,
    },
    away: {
      name: "味全龍",
      ...
      pitcher: {
        name: "梅賽鎯",
        era: "1.59", // estimate · 2026 官網累計成績表(Tim 截圖手抄)· 68 IP(11 先發)· 8-1 王牌級(2025 2.57 微回歸風險)
        k9: "6.1", // estimate · 46 K / 68 IP × 9
        whip: "1.01", // estimate · 官網每局被上壘率 1.014(58 H + 11 BB / 68 IP)
        bb9: "1.5", // estimate · 11 BB / 68 IP × 9 · 頂級控球
        hr9: "0.40", // estimate · 3 HR / 68 IP × 9
      },
      recent: ["W", "W", "L", "W", "W"], // placeholder · 味全 38-18-0(.679 全聯盟最強)
      winRate: 63,
    },
    topScores: [
      // 雙方先發都能投、梅賽鎯王牌 → 低分;味全最強隊 lean(格式 home : away = 台鋼 : 味全)
      { score: "1 : 3", probability: 9.5 },
      { score: "2 : 3", probability: 9.0 },
      { score: "1 : 2", probability: 8.5 },
      { score: "0 : 2", probability: 7.5 },
  ...
  //   #168 天母 · 富邦(阿部雄大 away)vs 味全(梅賽鎁 home)· W-L 富邦 27-22-0(.551)/ 味全 33-18-0(.647 最強)
  //     味全全聯盟最強 + 主場 + 梅賽鎁 2026 ERA 1.63(60.2 IP · 但 K9 僅 5.6 / WHIP 1.09 / BAA .241 =
  //     ERA 略優於內容、有回歸風險,控球好 BB9 1.6)。 富邦客場 .551 中段,但先發阿部雄大內容驚人:ERA 3.07
  //     看似普,WHIP 0.82 / BAA .152 / K9 7.4 全壓制級(29.1 IP 小樣本 · 2 轟拉高 ERA、底子其實比 ERA 好
  //     很多)→ 客隊先發內容甚至略蓋主隊先發,抵掉一部分味全的隊強+主場。 三優扣阿部壓制 → 味全 56 /
  //     富邦 44 · conf 52(偏味全但不裝神準:阿部雄大底子壓制 + 小樣本變異 → 比 #163 對統一的 58 再收斂)。
  {
    id: "cpbl-260617-02",
    league: "CPBL",
    date: "2026 · 06 · 17  ·  星期三",
    ...
    home: {
      ...
      pitcher: {
        name: "梅賽鎁",
        era: "1.63", // estimate · 2026 官網累計成績表(Tim 截圖手抄)· 60.2 IP(10 先發)· ERA 略優於內容
        k9: "5.6", // estimate · 38 K / 60.2 IP × 9 · 三振中庸
        whip: "1.09", // estimate · 官網每局被上壘率 1.087(55 H + 11 BB / 60.2 IP)
        bb9: "1.6", // estimate · 11 BB / 60.2 IP × 9 · 控球好
        hr9: "0.30", // estimate · 2 HR / 60.2 IP × 9
      },
      recent: ["W", "W", "L", "W", "W"], // placeholder · 味全 33-18-0(.647 全聯盟最強)
      winRate: 56,
    },
    away: {
      name: "富邦悍將",
      ...
      pitcher: {
        name: "阿部雄大",
        era: "3.07", // estimate · 2026 官網累計成績表(Tim 截圖手抄)· 29.1 IP(5 先發 · 小樣本)· 底子優於 ERA
        k9: "7.4", // estimate · 24 K / 29.1 IP × 9 · 會吊人
        whip: "0.82", // estimate · 官網每局被上壘率 0.818(15 H + 9 BB / 29.1 IP)· 壓制級
        bb9: "2.8", // estimate · 9 BB / 29.1 IP × 9
        hr9: "0.61", // estimate · 2 HR / 29.1 IP × 9 · 2 轟拉高 ERA
      },
      recent: ["W", "L", "W", "L", "W"], // placeholder · 富邦 27-22-0(.551)
      winRate: 44,
    },
    topScores: [
      // 兩位好內容先發(梅賽鎁 1.63 / 阿部底子壓制)→ 低分;味全最強+主場 lean、阿部壓制抵一部分(格式 home : away = 味全 : 富邦)
      { score: "2 : 1", probability: 9.0 },
      { score: "3 : 2", probability: 8.5 },
      { score: "3 : 1", probability: 8.0 },
      { score: "2 : 0", probability: 7.5 },
      { score: "4 : 2", probability: 7.0 },
    ],
    aiConfidence: 52,
  },
  ...
  //   ⚠️ 兩場都重度降雨(#151 降雨 100% · #152 降雨 90% · 皆室外場)→ 高機率延賽。 仍照誠實鎖賽前
  //   引擎線(costly signal:打了才有結算)· 延賽則官網無 GameResult=0 → 自動結算正確略過(不假裝有結果)·
  //   打了則 GitHub Action 每 3h 自動入帳本。 不預設 postponed(等實際宣布 · 不替天氣下判斷)。
  //
  //   #151 新莊 · 味全(蔣鎬 away)vs 富邦(阿部雄大 home)· 降雨 100% · W-L 味全 32-16-0 / 富邦 25-21-0
  //     味全全聯盟最強(.667)+ 蔣鎬 ERA 1.07 / 50.1 IP(50 局實打、頂級)= 隊伍+投手雙優。 富邦主場、
  //     阿部 ERA 3.86 看似普通,但 .150 BAA + WHIP 0.81 + 23 IP 小樣本 → 真實力應比 ERA 好(壓制強、
  //     失分多半序列/2 轟雜訊)→ 比表面接近。 味全雙優扣主場 → 味全 56 / 富邦 44 · conf 54(不裝把握)。
  {
    id: "cpbl-260609-01",
    league: "CPBL",
    date: "2026 · 06 · 09  ·  星期二",
    ...
    topScores: [
      // 蔣鎬頂級 + 阿部壓制 → 低分;味全隊強微 lean(格式 home : away = 富邦 : 味全)
      { score: "2 : 3", probability: 11.0 },
      { score: "1 : 2", probability: 10.0 },
      { score: "2 : 4", probability: 9.0 },
  ...
  //   #152 洲際 · 台鋼(艾速特 away)vs 中信(菲力士 home)· 降雨 90% · W-L 台鋼 26-21-1 / 中信 15-31-1
  //     台鋼戰績佳(.553)+ 艾速特 ERA 1.53 / 53 IP(多年王牌 2024 2.77 / 2025 2.23 · 穩)= 隊伍+投手雙優。
  //     中信全聯盟最差(.326)· 菲力士 2026 ERA 9.00 但僅 9 IP / 2 場 = 樣本太小不能當真(2025 是 1.91
  //     / 127 IP 的好投手 → 用 2025 基準錨定真實力,不對 9 局雜訊過度反應)。 ⭐ 引擎刻意「不裝神準」:
  //     報馬仔看中信投手爆 + 墊底會喊「台鋼穩贏 75%」· 我們只給 57%(9 局不算數 + 單場高變異)= 克制就是產品。
  //     台鋼雙優扣中信主場 + 菲力士真實力其實不差 → 台鋼 57 / 中信 43 · conf 55。
  {
    id: "cpbl-260609-02",
    league: "CPBL",
    date: "2026 · 06 · 09  ·  星期二",
    ...
    home: {
      ...
      pitcher: {
        name: "菲力士",
        era: "1.91", // estimate · 2025 基準(2026 僅 9 IP / ERA 9.00 樣本不足、近況差 · 用 2025 真實力錨定)
        k9: "6.7", // estimate · 2025 · 95 K / 127.1 IP × 9
        whip: "1.06", // estimate · 2025 · (101 H + 34 BB) / 127.1 IP
        bb9: "2.4", // estimate · 2025 · 34 BB / 127.1 IP × 9
        hr9: "0.28", // estimate · 2025 · 4 HR / 127.1 IP × 9
    ...
    away: {
      ...
      pitcher: {
        name: "艾速特",
        era: "1.53", // estimate · 2026 官網截圖 · 53 IP · 多年王牌(2024 2.77 / 2025 2.23)
        k9: "8.8", // estimate · 52 K / 53 IP × 9
        whip: "0.94", // estimate · (34 H + 16 BB) / 53 IP
        bb9: "2.7", // estimate · 16 BB / 53 IP × 9
        hr9: "0.17", // estimate · 1 HR / 53 IP × 9 · 極少被轟
    ...
    topScores: [
      // 台鋼隊強+王牌 vs 中信墊底+投手近況差 → 台鋼 lean、中分(格式 home : away = 中信 : 台鋼)
      { score: "2 : 4", probability: 10.5 },
      { score: "1 : 4", probability: 9.5 },
      { score: "2 : 3", probability: 9.0 },
      { score: "1 : 3", probability: 8.5 },
