...
// ── ZONE 27 · 拒絕標準(申請前先公開)─────────────────────
// 申請 Founders 27 之前 · 先把「我們會拒絕哪 5 種人」攤開講清楚。
...
const REFUSAL_RATIONALES: ReadonlyArray<RefusalRationale> = [
  ...
  },
  {
    pattern: "要求折扣 / 綁約 / 團購價",
    rationale:
      "要求 NT$ 2,700 打折、跟 BLACK CARD 綁約混價、老客戶特價、或公司團購量大折扣 · 不通過。NT$ 2,700 是固定價 · 對每一位都一樣 · 不開折扣、不混不同會員的價格。",
    seeHref: "/founders",
  ...
  },
  {
    ...
    rationale:
      "要求加入產品投票、治理權、DAO、或創始會員的決策投票權 · 不通過。產品方向由 Tim 一個人扛 · 創始會員不投票。真正的透明 · 是把開發日誌(/now)跟路線圖(/roadmap)公開給你看 · 不是搞一個投票的形式。",
    seeHref: "/roadmap",
