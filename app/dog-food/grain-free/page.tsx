  ...
  const faq = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "FDA 在 2018 年開始調查，2022 年 12 月結束，表示沒有證據支持無穀飼料會造成或加重擴張性心肌病。但獸醫營養學界的立場是，飲食相關的擴張性心肌病是有紀錄的病例類型，已有三十幾篇研究，機轉尚未查明。目前的線索指向的不是「無穀」，而是豆類（豌豆、扁豆、鷹嘴豆、各種 bean）含量高的配方 —— 含穀的飼料一樣可能豆類很高。這不是換飼料的理由，是看成分表的理由。狗出現咳嗽、呼吸困難、無力要看獸醫，那不是飼料問題。",
        },
      },
      {
        "@type": "Question",
    ...
    <main style={{ maxWidth: 700, margin: "0 auto", padding: "0 20px 120px" }}>
      ...
      <div style={box}>
        ...
        <p style={{ margin: "0 0 14px", fontSize: 15.5, lineHeight: 1.95 }}>
          ...
          機轉還沒查清楚 —— 而目前的線索指向的<b>不是「無穀」</b>，
          是<b style={{ color: "var(--cut)" }}>豆類含量高的配方</b>。
        </p>
        <p style={{ margin: 0, fontSize: 15.5, lineHeight: 1.95 }}>
      ...
      <Box tone="warn">
        ...
        <br />
        <b>狗出現咳嗽、呼吸變喘、容易累、無力 —— 那要看獸醫，不是換飼料。</b>
        心臟的事我們沒有資格判斷。
      </Box>
