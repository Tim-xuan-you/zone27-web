...
export const metadata = createPageMetadata({
  ...
  ogDescription:
    "贏了曬單、輸了刪文是別人的玩法。 我們把自己搞砸過、後來修好的事做成一頁,永遠掛著。",
  path: "/corrections",
});
    ...
    <div className="flex flex-col flex-1 min-h-screen">
      ...
      <main id="main">
        ...
        <section className="mx-auto max-w-3xl w-full px-6 sm:px-10 pt-20 pb-12">
          ...
          <p
            className="text-mute text-base leading-relaxed zh-body"
            style={{ fontFamily: "Georgia, serif", textWrap: "pretty" }}
          >
            我們自己做錯、後來自己抓到並修好的事,每一筆都寫清楚:
            <strong className="text-bone">當初錯在哪 → 怎麼被發現 → 哪天修的 → 連到原始紀錄。</strong>
          </p>
        </section>
