...
const LOCKED: { quarter: string; items: RoadmapItem[] }[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        body: "2026-05-21 上線 · 27 visitor-discoverable routes 索引化 · ⌘K (Mac) / Ctrl-K (Win) 開啟 · ↑↓ 導航 · ↵ 開啟 · mobile ⌕ icon trigger (Round 12) · Round 29 加 /member 後達 27 entries。/admin 因 noindex 不在 palette。無 fuse.js 無 telemetry 無 recently-used (per disclosure philosophy)。",
      },
      {
