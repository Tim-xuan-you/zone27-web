...
const LOCKED: { quarter: string; items: RoadmapItem[] }[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        body: "2026-05-21 上線 · 32 visitor-discoverable routes 索引化 · ⌘K (Mac) / Ctrl-K (Win) 開啟 · ↑↓ 導航 · ↵ 開啟 · mobile ⌕ icon trigger (Round 12) · Round 30 W5 加 /login + Round 31 W-S /founders/ledger + W-X3 /membership/black-card 後達 32 entries。/admin · /auth/callback · /auth/signout 因 noindex / 內部 redirect 不在 palette。無 fuse.js 無 telemetry 無 recently-used (per disclosure philosophy)。",
      },
      {
