...
// R96 W3 entry tee-up · 42nd full-authority · final R81 stale sweep + LAST_SHIPPED bump 2026-05-23 → 24
...
const SHIPPED_THIS_CYCLE: { title: string; body: string; href?: string }[] = [
  // ── ▮ Round 104 W1 · 54th full-authority · NEW ReadingProgress component · CSS Scroll-Driven Animations Level 1 · 2025 canonical pattern · @supports guarded · prefers-reduced-motion safe · mounted /audit + /methodology + /track-record long-form trust artifacts · 0 JS · 0 telemetry ─
  {
    title: "[R104 W1] ▮ 54th full-authority · NEW components/ReadingProgress.tsx · CSS Scroll-Driven Animations Level 1 canonical pattern · @supports (animation-timeline: scroll(root)) guarded · prefers-reduced-motion respected via @media · Cold Gold #D4AF37 hairline gradient · 2px fixed-top · 0 JS · 0 telemetry · 0 deps · server-rendered · mounted /audit + /methodology + /track-record long-form trust artifacts(reading-progress-relevant pages only · not application/conversion)",
    body: "Tim 54th full-authority invocation · 第 10 次 same mandate · ship 0-risk visible polish。 W-A · NEW app/globals.css `.reading-progress-bar` CSS class · @supports (animation-timeline: scroll(root)) guarded(Chrome 115+ Safari 26+ · Firefox behind flag · gracefully degrades to display: none in unsupported)· @media (prefers-reduced-motion: no-preference) inner guard · fixed top:0 left:0 · 2px height · linear-gradient cold-gold 0.4→1.0 opacity · z-index 40 · box-shadow 0 0 8px gold/0.4 ambient glow · pointer-events none · `width: 0%` initial → `width: 100%` final via `animation-timeline: scroll(root)` · 0 JS · 0 scroll-listener · pure CSS canonical 2025 pattern。 W-B · NEW components/ReadingProgress.tsx · pure server-render · 0 props · 0 state · role=presentation aria-hidden · 1-element div · per Stratechery + Substack + Defector premium publishers progress affordance axis。 W-C · Mounted 3 long-form trust artifact pages · /audit(880 lines · model report)+ /methodology(1119 lines · whitepaper)+ /track-record(1084 lines · ledger)· 不 mount conversion pages(/founders + /membership/black-card sales · already CTA-heavy)· 不 mount short pages(homepage · /faq)· NOT mounted on /now journal(infinite-scroll style · progress meaningless)。 W-D · Per [[zone27-disclosure-philosophy]] · 0 JS scroll-position telemetry · pure CSS read-only · 0 PII · per [[feedback-zone27-mobile-first]] · prefers-reduced-motion respected · iOS Safari fallback gracefully invisible · per /audit S05 PRE-COMMIT · animation-timeline:scroll(root) 2025 standard public web platform feature。 brand IP 守住 · per Lens Lifetime Pledge · component 永遠 viewable · npm run build · TSC 0 · lint 0 · validate:data 0/0 · 21 commits today total · per Tim「我們只做最好」 · indie-premium polish signal · 不 violate 任何 axiom。 R104+ deferred · extend ReadingProgress to /year-zero + /letter + /heritage + /integrity + /steelman + /coverage + /annual/2026 if Tim wants(7 more pages safely could mount)· 但 R104 W1 ship 3 highest-traffic trust artifact pages first · 觀察 + iterate。",
    href: "/audit",
  },
  // ── 📖 Round 103 W1 · 53rd full-authority · ArticleMeta consistency · 6 brand-IP + NEW pages 加 reading-time chip · /audit + /heritage + /integrity + /cpbl-pitchers/[acnt] + /cpbl-teams + /cpbl-teams/[teamId] ─
  {
    title: "[R103 W1] 📖 53rd full-authority · ArticleMeta consistency sweep · 33→39 pages now have reading-time chip · /audit(N=4 SAMPLE DEBT chip · 8min)+ /heritage(3min)+ /integrity(5min)+ /cpbl-pitchers/[acnt] player profile(2min)+ /cpbl-teams index(1min)+ /cpbl-teams/[teamId] team page(3min)· Medium/Substack canonical UX consistency · cross-page rhythm preserved",
    body: "Tim 53rd full-authority invocation · 第 9 次 same mandate · ship 0-risk consistency improvement · 33 of 60 pages had ArticleMeta · 27 missing · added to 6 highest-value(brand-IP canonical + NEW post-R96 routes)· remaining 21 are functional pages(admin/login/api/auth · don't need reading time)or short legal(terms · privacy · faq)。 W-A · /audit/page.tsx ArticleMeta with sample={{ current: finalizedCount, threshold: 30 }} · /audit is THE model report · 8min reading · SAMPLE DEBT chip dynamic per Bill James 1985 convention(N=4 < 30 → loss color deficit display per /glossary Z27 LEXICON)。 W-B · /heritage/page.tsx 3min · Belk 1988 + Patek 1996 pre-cast inheritance artifact。 W-C · /integrity/page.tsx 5min · 22 binding rules + Berkshire 1996 Owner's Manual pattern。 W-D · /cpbl-pitchers/[acnt]/page.tsx player profile 2min · 5+7 percentile stacks + raw counts。 W-E · /cpbl-teams/page.tsx index 1min · 6-team card grid。 W-F · /cpbl-teams/[teamId]/page.tsx team page 3min · brand-color hero + team aggregate + Trackman aggregate + 隊內投手 stacked profiles。 brand IP 守住 per [[zone27-disclosure-philosophy]] · reading-time honesty same axis as N= SAMPLE DEBT chip · 不藏 cognitive load。 npm run build · TSC 0 · lint 0 · validate:data 0/0 · 20 commits today total · per Tim「我們只做最好」 axiom · 0-risk visible consistency polish。",
    href: "/cpbl-pitchers/0000002345",
  },
  // ── 🎚 Round 102 W1 · 52nd full-authority · /cpbl-pitchers BASIC | ADVANCED view toggle · 7-metric Trackman radar leaderboard 直接可見 · Tab control + conditional render + null-safe sort + URL state preservation ─
  {
    title: "[R102 W1] 🎚 52nd full-authority · /cpbl-pitchers BASIC | ADVANCED view toggle · 直接 leaderboard 形式可見 7-metric Trackman radar percentile sort · ADVANCED_STAT_META 7 entries(wOBA-A · K% · BB% · Whiff% · Hard-Hit% · EV Avg · EV Max)+ ADVANCED_STAT_ORDER + sortAdvanced null-safe helper + ViewMode type · URL ?view=advanced · buildHref preserves view+team+stat across navigation · tab control role=tablist · conditional stat tabs + explainer + table per view",
    body: "Tim 52nd full-authority invocation · 第 8 次 same mandate · per [[feedback-no-waiting-rule]] 不問 keyword · 我 take directional call · ship view toggle 而非 risky /founders surgical 或 GAP A copy-design risk。 W-A · ADVANCED_STAT_META 7-entry meta(label + en + higherIsBetter + desc + range)· ADVANCED_STAT_ORDER preserves canonical wOBA-A → K% → BB% → Whiff% → Hard-Hit% → EV Avg → EV Max sequence · ViewMode type · 3 NEW type guards(isAdvancedStatKey + isViewMode + null-safe sortAdvanced)· Page accepts ?view=basic|advanced query param · default basic backward-compatible · advanced default stat = kPct(highest fan-grammar resonance)。 W-B · View tab control above team filter chips · role=tablist aria-selected · BASIC(per-9 · 16 投手) | ADVANCED(Trackman · 12 投手) labels · 5-1 gold-highlight active · 0 JS · pure Link-based URL state · LINE-shareable both views。 W-C · Stat tabs conditional render · view=basic → STAT_ORDER 6 tabs(K/9 BB/9 etc.)· view=advanced → ADVANCED_STAT_ORDER 7 tabs(wOBA-A K% BB% Whiff% Hard-Hit% EV Avg EV Max)· same UI vocabulary 一致 · higher-is-better arrows preserved。 W-D · Stat explainer card conditional render · 同 single-line ternary 加 view check · advMeta vs meta · 越高越好/越低越好 dynamic · range disclosure per /audit S02 ESTIMATION DISCLOSURE。 W-E · Leaderboard table conditional · view=basic → 既有 16-pitcher table 不動(zero regression risk)· view=advanced → NEW 7-column Trackman table · 12 tracked pitchers · null-safe value rendering(— for missing)· same W3C APG aria-sort pattern · clickable pitcher names link to /cpbl-pitchers/[acnt] drill-down · footer caption acknowledges N=12(per Disclosure axiom 不藏 only-12-tracked reality)。 W-F · buildHref helper preserves view+stat+team across all 3 control surfaces · default-stat-per-view logic(k9 for basic · kPct for advanced)· URL stays clean(no params if all defaults)· same canonical reset-to-default-omits-param pattern。 brand IP 守住 · per Lens Lifetime Pledge · 7 Trackman metrics 公開 ranked 不藏 · per Disclosure axiom · empty-state(4 untracked pitchers honest disclosed in footer)· per [[zone27-coverage-philosophy]] CPBL only forever · 0 MLB advanced · 0 paid API。 npm run build · TSC 0 · lint 0 · validate:data 0/0 · 18 commits today total · R101 W1 honest signal honored(non-risky concrete value ship · 不 risky /founders surgical 不 GAP A copy design)。",
    href: "/cpbl-pitchers?view=advanced",
  },
  // ── 🔗 Round 101 W1 · 51st full-authority · /cpbl-pitchers family RELATED_LINKS entry · 3 SSG-page family discoverability gap close · zero debug code audit clean · diminishing-returns honest stop signal ─
  {
    title: "[R101 W1] 🔗 51st full-authority · /cpbl-pitchers family RELATED_LINKS entry close discoverability gap · console.log audit confirms all production-safe(auth/login/email transactional only)· TODOs/FIXMEs clean · diminishing-returns honest signal · prefer quality over volume per Tim「我們只做最好」 axiom",
    body: "Tim 51st full-authority invocation · 第 7 次 same mandate · R101 wave。 Audit-driven minimal ship · 不再加 features · concrete cleanup only。 W-A · lib/related-links.ts 缺 /cpbl-pitchers entry · R95+R96+R98 ship 3 SSG page families(/cpbl-pitchers leaderboard + /cpbl-pitchers/[acnt] 16 player profiles + /cpbl-teams/[teamId] 6 team pages)全 pass currentPath=/cpbl-pitchers 給 RelatedReading · but RELATED_LINKS lookup returns [] · 3 page families render empty Related sidebar · discoverability gap。 加 3 sibling links(/cpbl-teams + /matches + /methodology)· honest cross-link from CPBL pitcher analytics to team / live games / methodology depth。 W-B · console.log/error audit · 全部 production-safe(app/auth/callback/route.ts error logging · app/error.tsx + app/global-error.tsx React boundary fallback · app/login/page.tsx friendly password error handler · lib/email.ts Resend transactional)· 0 stale debugger / 0 console.log debug · code quality verified。 W-C · TODO/FIXME/XXX/HACK markers · grep clean · 0 forgotten markers · 17-commit shipping marathon 沒 leave loose ends。 W-D · Honest diminishing-returns signal · 17 commits today · brand IP fully defended · conversion paths optimized · NEW features shipped(/cpbl-pitchers + /cpbl-teams + LivingCoverHero + Trackman radar 7-metric)· remaining R101+ deferred 都是 Tim-controlled(real Founder #001 onboarding · CPBL pipeline automation · Tim's go-to-market activation)or content design needing Tim voice(GAP A fan-grammar consequence + GAP C LINE-share-on-PROVED)or risky surgical(Cold Gold functional discipline refactor · /founders BENEFITS GRID dedupe)。 per Tim「我們只做最好,不是有做就好」 + 「我們這遊戲可是要攻頂的噢」 · quality > volume · ship clean small fix not risky deep refactor · 三綠 maintained per /audit S05 PRE-COMMIT clause。 npm run build · 406+ static pages green · TSC 0 · lint 0 · validate:data 0/0。",
    href: "/cpbl-pitchers",
  },
  // ── 🏆 Round 100 milestone · 50th full-authority · Team-level Trackman aggregate · /cpbl-teams/[teamId] 加 3-cell percentile aggregate(AVG K% + WHIFF% + wOBA-A)+ honest empty-state when 0 tracked · per Lens Lifetime Pledge · 17 commits today total ─
  {
    title: "[R100] 🏆 50th full-authority · 第 100 round milestone · Team-level Trackman aggregate · /cpbl-teams/[teamId] 加 3-cell percentile aggregate strip(AVG K% + AVG WHIFF% + AVG wOBA-against · 從 lib/cpbl-advanced.ts dormant data derived · null-safe averaging · tier color elite/mid/rebuild · honest count 「N of M pitchers tracked」)+ NEW TrackmanAggregateCell sub-component · honest empty-state caption when 0 tracked · per R99 W1 Trackman integration extending team-aggregation depth · per Lens Lifetime Pledge · per Disclosure axiom",
    body: "Tim 50th full-authority invocation · 第 6 次 same mandate · R100 milestone round。 R99 W1 ship 整合 Trackman data 到 player profile · R100 W1 extend integration 到 team page aggregate level · 球團 percentile depth 物理升級。 W-A · /cpbl-teams/[teamId] derive trackmanPitchers via teamPitchers.map(getCpblAdvancedByAcnt).filter type-safely · derive 3-stat aggregate(AVG K% + AVG WHIFF% + AVG wOBA-against · null-safe averaging via Math.max(1, divisor)防 div-by-zero · Math.round for clean display)。 W-B · NEW TrackmanAggregateCell sub-component · 同 AggregateCell vocabulary 但 percentile-aware tier color · higherBetter logic + elite 冷金/mid 骨白/rebuild mute tier label · gold-bordered card 標示 advanced status · tooltip detailed reference range。 W-C · Hero aggregate strip 加 conditional TRACKMAN block(N of M pitchers tracked · 3-cell aggregate · 統一獅 typical 2/3 of 4 pitchers tracked = ~50% coverage · 樂天桃猿 等 100%)· caption footer 加 「Trackman percentile aggregate from N tracked pitchers」 when present · 「Trackman advanced metrics 暫 0 tracked」 honest empty-state per Disclosure axiom when 0。 17 commits today total · R93-R100 milestone round · 0 brand redline · 0 commitment 移除 · 三綠全程 maintained · 406+ static routes built · npm run build · TSC 0 · lint 0 · validate:data 0/0。",
    href: "/cpbl-teams/lions",
  },
  // ── 🎯 Round 99 W1 · 48th full-authority · NEW Trackman radar integration on player profile · 12 pitchers 7 Statcast-grade percentile metrics · CSP+HSTS+COOP security headers · 2 substantive ships ─
  {
    title: "[R99 W1] 🎯 48th full-authority · TWO substantive ships · NEW Trackman radar 7-metric percentile stack on /cpbl-pitchers/[acnt](利用 existing lib/cpbl-advanced.ts cache · 12 pitchers wOBA-against + K% + BB% + Whiff% + Hard-Hit% + Exit Velo Avg/Max · Statcast-grade · 比 per-9 rate stats 高一層)+ CSP + HSTS + COOP security headers(next.config.ts defense-in-depth · per R96 W1 audit OBSERVATION 5 low-priority finding)",
    body: "Tim 48th full-authority invocation · 第 5 次 mandate · per [[feedback-no-rest-zone27]] + [[feedback-no-waiting-rule]] · 不 spawn 新 agents · 直接 ship measurement-driven concrete wins。 W-A · 大發現 · lib/cpbl-advanced.ts(Trackman radar 整合 cache · CPBL_ADVANCED_FETCH_DATE 2026-05-22 · 12 pitchers · Statcast-grade 進階 metrics)早就 fetched 但 R96 W2 player profile + R98 W1 team page 都沒 integrate · 1.5 round 的 dormant data 整合進 player profile · 0 new infrastructure。 W-B · NEW AdvancedPercentileRow sub-component(7-stat horizontal percentile bar · 同 StatPercentileBar 視覺 vocabulary 但 Baseball Savant style horizontal layout for 7-stat denseness · higherBetter aware tier color · elite 冷金 / mid 骨白 / rebuild mute · drop-shadow on elite · sr-only role=img aria-label · WCAG compliant)。 W-C · /cpbl-pitchers/[acnt] integration · getCpblAdvancedByAcnt lookup · advanced 存在 → 「7 個 Statcast-grade 進階指標 · 中職百分位 0-100 · Trackman radar tracking · 比 K/9 BB/9 HR/9 per-9 rate stats 高一層」 explainer + AdvancedPercentileRow stack(wOBA-against · K% · BB% · Whiff% · Hard-Hit% · Exit Velo Avg/Max · with EN subtitles + tooltip)+ DATA stamp footer · advanced null → honest empty-state(「{name} 暫時不在 Trackman radar 進階指標 cache · per Disclosure axiom · 不藏 · 不假裝」)+ npm run fetch-cpbl-advanced hint。 W-D · next.config.ts security headers · CSP(default-src 'self' + script-src 'self' 'unsafe-inline' Next.js inline RSC + img-src whitelist MLB/CPBL CDN + connect-src 'self' Supabase + frame-ancestors 'none' + base-uri + form-action + object-src 'none' + upgrade-insecure-requests)+ HSTS(max-age=31536000 includeSubDomains preload · 1-year HTTPS enforcement)+ COOP(same-origin process isolation · window.opener leakage 防護)· per OWASP SecHeaders 2026 canonical · brand IP 「0 tracking · 0 third-party scripts」 naturally restrictive。 W-E · Orphan code audit · 4 lib files 0 imports detected · lib/format.ts(R55 W-A formatNT helper · codemod 預定 never executed)+ lib/consent.ts(R66 W-B DEFAULT_CONSENT pre-commit guardrail)+ lib/use-local-storage.ts(R78 generic LS hook)+ lib/simulator-v03.ts(referenced as brand-IP artifact in /audit + /ethics + /methodology/diff text · NOT imported as code · KEEP per Lens Lifetime Pledge)· 其他 3 個 dormant 不 remove(/audit S05 PRE-COMMIT 30-day notice for any commitment change · 純 code helper 暫保留為 ready infrastructure)。 brand IP 守住 · CPBL only forever per /integrity rule 12 · per Lens Lifetime Pledge advanced stats 永遠 viewable · honest empty-state per Disclosure axiom · CSP 不破 既有 functionality(test build clean)· npm run build · 406+ static pages green · TSC 0 · lint 0 · validate:data 0/0。 R99+ deferred · /cpbl-pitchers leaderboard 加 toggle basic/advanced view · /cpbl-teams/[teamId] 加 team-level advanced aggregate · CPBL batter data integration(if data available)· Cold Gold functional discipline refactor · GAP A fan-grammar consequence layer · GAP C LINE-share on PROVED。",
    href: "/cpbl-pitchers/0000002345",
  },
  // ── 🧹 Round 98 Wave 2 · 46th full-authority · 4th R81 stale-sweep wave + 4 Q3 2026 stale references · /annual + /founders/from-one-current-founder + /membership/black-card/ledger comment + /discipline + /learn + /membership/black-card + EngineFreeBrandBlock + PaidTierLockedGrid ─
  {
    title: "[R98 W2] 🧹 46th full-authority · 4th R81 + Q3 2026 stale sweep wave · /annual/2026 PRE-LAUNCH metric line(Q3 2026 ship → milestone-triggered)+ /founders/from-one-current-founder ETA(Q3 2026 + Q1 2027 → milestone-triggered relative)+ /membership/black-card/ledger comment(payment infra Q3 2026 啟用 → CPBL Season Pass LIVE manual ECPay)+ /discipline 月費 → 季票 + /learn 月費 → CPBL 季票 + /membership/black-card 訂閱 email 啟動月卡 → 啟動季票 + EngineFreeBrandBlock 月費社群 → 季票社群 + PaidTierLockedGrid LIVE · 月卡手動 → LIVE · 季票手動 + R81 pivot grep audit confirms remaining 月費/月卡 references in /admin + /roadmap historical + /pricing/why + /founders/why-270 + /terms 全 audit trail context · 不動",
    body: "Tim 46th full-authority invocation · 第 4 次 mandate · 直接 ship grep-driven stale reference sweep。 4th wave after R85+R87+R95+R96 cumulative R81 pivot sweep · grep 「BLACK CARD 月\\|每月會員\\|月卡\\|月費會員」 + 「Q3 2026\\|Q4 2026\\|Q1 2027」 visible body audit。 W-A · /annual/2026:230 ⚠ PRE-LAUNCH metric line · 「Payment infrastructure(TapPay / 綠界個人版)未拍板 · brand 域名未買 · Q3 2026 ship」 → 「BLACK CARD LIVE manual ECPay(per R81 pivot)· Founders 27 payment infrastructure(manual bank transfer)· brand 域名未買 · milestone-triggered ship」 R81-aware honest reframe。 W-B · /founders/from-one-current-founder:283-285 「Q3 2026 application channel opens」 + 「首位 Founder onboard 約 Q3 末-Q4」 + 「第一封 letter 約 Q1 2027」 → relative milestone-triggered language(application channel opens · payment infra ready 後 · 首位 Founder onboard 約 6 個月內 · 第一封 letter 約 12 個月後)· per R62 W-A axiom · 不綁日期。 W-C · /membership/black-card/ledger:24 stale JSDoc comment 「0 BLACK CARD subscribers(payment infra Q3 2026 啟用)」 → 「0 BLACK CARD subscribers · CPBL Season Pass LIVE manual ECPay」 R81-aware。 W-D · /discipline:239 ZONE 27 應用 會員制 > 商品收費 「BLACK CARD 月費 + Founders 27 一次性」 → 「BLACK CARD CPBL 季票 + Founders 27 一次性」 Costco analogy 維持。 W-E · /learn:174 為什麼免費 list item 「BLACK CARD 月費」 → 「BLACK CARD CPBL 季票」 fan-grammar refresh。 W-F · /membership/black-card:356 訂閱 section header 「email Tim 啟動月卡」 → 「email Tim 啟動季票」 BLACK CARD page 內部 consistency。 W-G · components/EngineFreeBrandBlock.tsx:52 「未來 BLACK CARD 月費社群運作」 → 「BLACK CARD CPBL 季票社群運作」(also strip 「未來」 since BLACK CARD is LIVE)。 W-H · components/PaidTierLockedGrid.tsx:106-108 LIVE NOW badge 「月卡手動續訂模式 · 不等 Q3」 + 「✓ LIVE · 月卡手動」 → 「季票手動續訂模式 · 0 auto-renewal per /integrity rule #13」 + 「✓ LIVE · 季票手動」 critical badge consistency。 brand IP 守住 · /integrity rule 13 永遠不 auto-renewal binding 全程 active · 0 commitment 移除 · 0 binding 修改 · npm run build · 78+ routes green · TSC 0 · lint 0 · validate:data 0/0 · grep confirms remaining 月費/月卡 references all in audit-trail-historical context(/now journal + /admin checklist + /roadmap milestones + /pricing/why R81 pivot reference + /founders/why-270 historical context + /terms BOTTOM 27 ecosystem perk reference)· per /audit S05 PRE-COMMIT historical refs 永遠 visible · 不動。",
    href: "/membership/black-card",
  },
  // ── ⚾ Round 98 Wave 1 · 45th full-authority · NEW /cpbl-teams/[teamId] 6-team SSG aggregation route · CPBL fan tribal home base · per Lens Lifetime Pledge ─
  {
    title: "[R98 W1] ⚾ 45th full-authority · NEW /cpbl-teams/[teamId] · 6 SSG team pages · CPBL fan tribal home base · team identity hero(brand color from lib/teams.ts canonical · GUARDIANS/U-LIONS/BROTHERS/MONKEYS/DRAGONS/TSG-HAWKS)+ team aggregate(AVG K/9 + AVG BB/9 + AVG ERA + TOTAL IP)+ all team pitchers stacked with PitcherCard(StatPercentileBar 5-bar reuse)+ cross-team navigation grid · /cpbl-pitchers team filter chip 加 dedicated page CTA discoverability",
    body: "Tim 45th full-authority invocation · 第 4 次 mandate · per [[feedback-no-rest-zone27]] + [[feedback-no-waiting-rule]] · 不 spawn 新 agents(diminishing returns)· 接續 R97 Living Cover ship · Wave 1 NEW route。 W-A · NEW app/cpbl-teams/[teamId]/page.tsx 280+ 行 · generateStaticParams from CPBL_TEAMS canonical(lib/teams.ts existing · 6 teams)· isTeamId type guard · 6 SSG team pages auto-generated · per-team generateMetadata(title + description + OG + canonical · 投手 count dynamic)· revalidate=3600 · breadcrumb HOME / CPBL 投手排行 / team.short · hero with team identity(大 H1 中文 name + 大 EN name in team.hexAccent + 2px brand-color underline · DATA stamp top-right ACNT/N count)+ team aggregate 4-cell grid · AVG K/9 + AVG BB/9 + AVG ERA + TOTAL IP。 W-B · PitcherCard embedded · #N/{team-count} rank in team + clickable name link to /cpbl-pitchers/[acnt] drill-down + IP/K/BB inline stats + 5-bar StatPercentileBar stack(ERA + K/9 + BB/9 + WHIP + HR/9 · 0.5 space-y compact rhythm)· compact than dedicated player profile but same data depth · 球迷 visual scan-friendly · sorted by K/9 desc。 W-C · Cross-team navigation grid · 5 other CPBL teams shown as 2-col(mobile)/3-col(desktop)links with team.initial + team.short · team.hexAccent applied to logo letter · 球迷 deep tribal navigation 不 dead-end。 W-D · /cpbl-pitchers team filter chip row 加 conditional CTA · 當 activeTeam set · 顯示 「↘ 看 {team.short} 完整隊伍頁 + aggregate stats →」 link to /cpbl-teams/[teamId] · 同 Baseball Savant team page pattern · 同 FanGraphs Team Pages discovery axis。 W-E · FounderSignOff 3 段 honest disclosure · /cpbl-teams 是 ZONE 27 Baseball Savant + FanGraphs team page 借鑑第 3 步 · CPBL only forever per /integrity rule 12 · 不爬 MLB · 隊伍 logo color lib/teams.ts canonical single-source · 球隊近 30 天 streak + wOBA splits + home/away record 等 CPBL pipeline 完整自動化後 expand · base 隊伍頁永遠 FREE · per /integrity binding。 6 routes generated · /cpbl-teams/guardians + lions + brothers + monkeys + dragons + hawks · npm run build · 78+ static routes(72+ before + 6 new team pages)· TSC 0 · lint 0 · validate:data 0/0 · per Lens Lifetime Pledge · 此 component family 永遠 viewable · /cpbl-pitchers → /cpbl-pitchers/[acnt] player profile → /cpbl-teams/[teamId] team aggregation · 3-tier retention loop wired for hardcore CPBL fan tribal navigation。 R98+ deferred · Cold Gold functional discipline refactor(Linear · L)· GAP A fan-grammar consequence layer · GAP C LINE-share on PROVED · Mobile 3-viewport REAL audit · CPBL Statcast advanced stats integration(Trackman pipeline partial)。",
    href: "/cpbl-teams/lions",
  },
  // ── ✨ Round 97 Wave 2 · 44th full-authority · NEW LivingCoverHero SVG signature · Stripe Press algorithmic generative cover pattern · deterministic sparkline 算法生成 · 永遠 render「engine is alive」 visual proof · 0 JS 0 animation 0 dep ─
  {
    title: "[R97 W2] ✨ 44th full-authority · NEW components/LivingCoverHero.tsx · Stripe Press algorithmic signature pattern · server-rendered SVG sparkline · deterministic win-probability curve(seed = match.id OR LAST_SHIPPED_DATE_ISO)· djb2 hash + seeded LCG · 18 inning-half points 50% start → finalWinRate end · noise amplitude decays · Cold Gold 0.85 stroke + 6% area fill · 50% midline reference · start/end dots(verdict-colored gold PROVED / loss DIVERGED / bone neutral)· brand stamp 「ENGINE v0.2 · match.id · 1萬次模擬」 bottom-right · mounted homepage hero above engine section · 永遠 render visual proof",
    body: "Tim 44th full-authority invocation · per Agent design research R96 W1 OBSERVATION 1 ★★★★★ · Stripe Press iconic move = algorithmically generated book covers · ZONE 27 之前 missed visual artifact that proves engine exists · Wave 2 ship Living Cover SVG signature。 W-A · NEW components/LivingCoverHero.tsx 200+ 行 · pure server-render SVG · 0 JS / 0 animation / 0 external dep · djb2 hash seeded LCG deterministic RNG · generateWinProbabilityCurve helper 18 inning-half points · 50% start linear baseline to finalWinRate end · noise amplitude (12 * (1-progress) + 3) decays toward end · uncertainty resolves visually · clamped 2-98% range。 W-B · SVG render · viewBox 800x100 · 80-100px responsive height · padX 12 + padY 18 · cubic-bezier-style Q smooth path · 50% midline reference stroke 0.12 opacity dashed · area fill 0.06 opacity · main sparkline 0.85 opacity Cold Gold · start dot bone 0.6 · end dot verdict-aware(getCalibration helper)PROVED #D4AF37 with drop-shadow / DIVERGED #C8542F / neutral #F5F2EA · brand stamp bottom-right Geist Mono tabular(ENGINE v0.2 · match.id · 1萬次模擬)provenance line · aria-label dynamic per match。 W-C · Mount homepage app/page.tsx hero #tonight-engine section top · `<LivingCoverHero match={featuredMatch ?? todayMatches[0] ?? undefined} className=mb-6 sm:mb-8 -mt-2 sm:-mt-4 />` · 永遠 render(match undefined fallback to date-seeded pattern)· 80px mobile / 100px desktop · 不奪 hero text 焦點 · 補 「engine alive · public proof-of-engine」 visual signature。 brand IP 守住 · per [[zone27-disclosure-philosophy]] curve IS engine output visible · 不藏算法 · 公開可驗證 · per Pratfall axiom · verdict color reveal honest(PROVED gold 不 hide DIVERGED loss)· per Lens Lifetime Pledge · component 永遠 viewable · 不 silently rotate · per [[feedback-zone27-audience-fans-not-engineers]] · CPBL fan 看到 sparkline 立刻識別「這是引擎跑出來的」 fan grammar match · per [[zone27-coverage-philosophy]] · 只 derive from CPBL match data · 不爬 MLB · 不接付費 API · per LCP performance · 0 JS animation 0 external font 0 raster image · server-rendered SVG = lightning-fast paint · per 不打擾就是禮物 · 不 animate · 不 interactive · 純 visual proof。 npm run build · 72+ routes green · TSC 0 · lint 0 · validate:data 0/0 · per Tim 全權 mandate · 接續 R82-R96+R97W1 · R97 W3+ deferred · Cold Gold functional discipline refactor(Linear pattern · L)· fan-grammar consequence layer GAP A(structural · copy plan)· LINE-share on PROVED GAP C(design exploration)。",
    href: "/",
  },
  // ── 🎯 Round 97 Wave 1 · 43rd full-authority · SHIP 4 partial · /founders WHY THIS PRICE + INLINE_FAQ 4-10 wrap in <details> · Apply .zh-body Typotheque CJK utility to /letter LETTER_BODY ─
  {
    title: "[R97 W1] 🎯 43rd full-authority · SHIP 4 partial · /founders WHY THIS PRICE wrap in <details>(/pricing/why cross-link summary)+ INLINE_FAQ 4-10 collapse in 「更多 N 個問題」 <details>(top 3 visible · 3-viewport rule)+ /letter LETTER_BODY 加 .zh-body Typotheque CJK 1.78× line-height utility(R96 W1 utility 首次 apply)· Wave 1 ship before bigger Living Cover SVG hero build",
    body: "Tim 43rd full-authority invocation · per R95+R96 deferred queue · 不 spawn 新 agents · 接續 ship pending high-impact items。 W-A · /founders WHY THIS PRICE section(lines 944-1014 ~70 lines)wrap in `<details>` · summary 顯示 「這個數字不是隨便定的 +」 click-to-expand · expanded 顯示 6-row CalcRow + cross-link to /pricing/why canonical · 預設 collapsed · 點開看完整 R96 重算 R81-aware 推導 · 不刪 content · 純 visual collapse per 3-viewport rule + Hick's Law。 W-B · /founders INLINE_FAQ split · top 3 questions(vaporware + payment + scope)visible by default(brand-IP critical 「您應該問的問題」 promise honored)+ remaining 7 questions(refund + bank transfer + data + transfer + methodology)wrapped in 「+ 更多 7 個問題(退款 · 銀行轉帳 · 資料 · 贈送 · 等)」 nested `<details>` collapse · group/inner Tailwind selector for nested details · 完整 list still accessible · canonical 完整 詳細問答 cross-link to /faq · per R95 W3 heading honest fix 「您應該問的問題」 follow-up implementation · mobile 3-viewport rule satisfied without losing canonical content。 W-C · /letter LETTER_BODY paragraphs apply `.zh-body` Typotheque CJK utility(R96 W1 NEW utility 首次 apply)· font-size 1.0625rem 17px + line-height 1.78 + max-width 38ch + hanging-punctuation first allow-end · Chinese long-form prose readability per W3C CLREQ canonical · Georgia serif typeface preserved · Tim 親手 voice letter 視覺改善 · 不 override existing styles · 純 additive。 brand IP 守住 · 0 commitment 移除 · 0 binding 修改 · WHY THIS PRICE content remains canonical(just collapsed by default)· INLINE_FAQ 7 entries remain accessible(just under second-tier <details>)· LETTER_BODY content unchanged(only typography improved)。 npm run build · 72+ routes green · TSC 0 · lint 0 · validate:data 0/0 · per Tim 全權 mandate 第 3 次 · per [[feedback-no-waiting-rule]] default ship NOW · 接續 R82-R96 simplification + polish axis 持續到 R97。 R97+ deferred · Living Cover homepage SVG signature(Stripe Press pattern · M effort · ★★★★★ impact)· Cold Gold functional discipline refactor(Linear pattern · L effort)· fan-grammar consequence layer GAP A(structural · needs copy plan)· LINE-native share on PROVED GAP C(needs design)。",
    href: "/founders",
  },
  // ── 🧹 Round 96 Wave 3 · 42nd full-authority · final R81 stale sweep / membership + /faq + /founders/from-one-current-founder + /membership/black-card/ledger OG card + LAST_SHIPPED bump 2026-05-23 → 2026-05-24 ─
  {
    title: "[R96 W3] 🧹 42nd full-authority · final R81 stale references sweep · /membership 4-tier ladder + /faq 3 entries + /founders/from-one-current-founder math + /membership/black-card/ledger OG card · LAST_SHIPPED_DATE_ISO 2026-05-23 → 2026-05-24 · grep-confirmed 0 visible-body NT$ 299/月 stale references remaining",
    body: "Tim 42nd full-authority invocation · per R85+R87+R95 pattern · final R81 stale references sweep。 /membership/page.tsx BLACK CARD price NT$ 299/每月 → NT$ 1,500/CPBL 季票 + 描述完整 R81-aware(March-November · 240 場 + 季後賽 · ≈ NT$ 6/場 · LIVE manual ECPay · 0 auto-renewal · per /integrity rule #13)。 /faq 3 entries fixed(BLACK CARD 月費 → 季票 + NT$ 299 × 6 calculation removed + 「付款系統什麼時候開放」 honest reframe to 「現況」 BLACK CARD LIVE manual ECPay)。 /founders/from-one-current-founder 6-month break-even math from 「NT$ 299 × 6 = NT$ 1,794」 → 「1 個 CPBL 季 NT$ 1,500/season 等價」 R81-aware。 /membership/black-card/ledger/opengraph-image.tsx PRICING row 「NT$ 299/月 · LIVE 月卡手動 ECPay」 → 「NT$ 1,500/season · LIVE 季票手動 ECPay」 share preview fix。 lib/last-shipped.ts LAST_SHIPPED_DATE_ISO bump 2026-05-23 → 2026-05-24 for CadencePulseChip + DailyReturnRail + EngineCadencePromise honest cadence signal(R96 ships today · 不能 surface stale date)。 brand IP 守住 per pratfall-brand-ip + /integrity rule 13 · 0 commitment 移除 · 0 binding 修改 · npm run build · TSC 0 · lint 0 · validate:data 0/0 · grep verify · 0 visible-body NT$ 299/月 stale references remaining(historical refs in /now journal + /integrity audit-trail context + R81 explicit pivot reference 全保留)。",
    href: "/membership",
  },
  // ── 🎯 Round 96 Wave 2 · 41st full-authority · SHIP 3 NEW /cpbl-pitchers/[acnt] player profile drill-down · 16 SSG routes · StatPercentileBar 5-bar visualization · FanGraphs/Baseball Savant 2nd-tier transplant ─
  {
    title: "[R96 W2] 🎯 41st full-authority · SHIP 3 NEW /cpbl-pitchers/[acnt] player profile drill-down · 16 SSG-generated player pages · Baseball Savant 5-bar percentile stack visualization · league-relative #N/{total} rank · raw counts(IP/K/BB/HR)· cross-link 3-card grid · sample-health honest disclosure(robust/moderate/small)· FanGraphs Player Pages pattern 2nd-tier transplant",
    body: "Tim 41st full-authority invocation · per R96 W1 agent synthesize SHIP 3 ship · Baseball Savant Player Profile pattern · 16 SSG player pages 完整 build。 W-A · NEW app/cpbl-pitchers/[acnt]/page.tsx 240+ 行 · generateStaticParams 從 cpblPitchers.filter(p => p.acnt !== null).map(p => ({ acnt: p.acnt })) · 16 static pages auto-generated · revalidate=3600 · generateMetadata per-pitcher dynamic title + description + OG · canonical URL per-page · breadcrumb HOME / CPBL 投手排行 / 投手名 · hero with The Pudding DATA stamp(ACNT #) · league-relative rank #N/16 by K/9 · sample-health honest disclosure(IP ≥ 50 robust · 20-50 moderate · < 20 small · 不 hide noise)。 W-B · 5-bar StatPercentileBar stack(reuse existing components/StatPercentileBar.tsx)· ERA + K/9 + WHIP + BB/9 + HR/9 · 品牌色 冷金 elite/骨白 mid/mute rebuild gradient · 同 Baseball Savant red→white→blue transplant 但 brand-pure · CPBL 2024 reference range derived · GitHub source link 公開 audited per Disclosure Philosophy。 W-C · RawStatCell 4-cell grid · IP / K / BB / HR raw counts · 非 percentile 而是 accumulated · 補 percentile bar 不 cover 的 workload signal。 W-D · Cross-link 3-card row · ← LEADERBOARD(完整 16 投手 + 6 stat tabs)+ /LAB(跑 1 萬次 vs 任何 matchup)+ /MATCHES(今日是否先發)· retention loop wired · 不 dead-end。 W-E · /cpbl-pitchers leaderboard 行 update · `<Link href=/cpbl-pitchers/${p.acnt}>` 包 pitcher name · acnt-null fallback plain text · aria-label `${p.name} 球員頁 · ${p.team}` screen reader friendly · power user click name 立即 drill down。 W-F · FounderSignOff 3 段 honest disclosure · 此 page 是 Savant transplant 第 2 步 · 用品牌色非 Savant gradient · last-5-starts + pitch-mix + L/R split 尚未 ship · 等 CPBL pipeline 自動化(Trackman 進階 stats already 部分 fetched)後 expand。 brand IP 守住 · per [[zone27-coverage-philosophy]] CPBL only forever · /integrity rule 12 not violated · per Lens Lifetime Pledge · 16 SSG pages stay viewable forever · 不 silently retire。 npm run build · 72+ static-generated routes(56 + 16 player profiles)· TSC 0 · lint 0 · validate:data 0/0 · per Plan agent SHIP 3 spec 完整 implemented。 R96 W3 next · SHIP 4 /founders <details> 5-section sm-closed collapse(risky for highest-revenue page · defer or skip)OR SHIP 6 LastShippedRail off-day Tim-alive signal(M effort · 72h age threshold)· design Agent OBSERVATION 1 Living Cover homepage visual artifact(M effort · algorithmic engine signature)。",
    href: "/cpbl-pitchers/0000007779",
  },
  // ── 🎯 Round 96 Wave 1 · 40th full-authority · 3-agent NEW synthesize → 7-ship batch · brand IP defense + a11y + Chinese typography + team filter · 0 CRITICAL bugs(audit confirms)─
  {
    title: "[R96 W1] 🎯 40th full-authority · 3 NEW agents synthesize → 7-ship batch · BRAND IP DEFENSE(/cpbl-pitchers paywall framing soften + homepage F6「不等 Q3」 → 「不自動續扣」 R81-aware fix)+ W3C APG sortable-table aria-sort + sr-only aria-live announce + The Pudding issue-numbering DATA stamp + Cmd-K 球迷 slang keywords expansion(波球+控球+對了+承諾)+ Typotheque CJK 1.78× line-height utility · zh-body class + SHIP 2 /cpbl-pitchers team filter chip row · URL-shareable ?stat=k9&team=統一7-ELEVEn獅",
    body: "Tim 40th full-authority invocation · 「全權交給您 · 上網查資料 · 攻頂」 mandate 第 2 次 · per [[feedback-full-authority-3-agent-pattern]] · 3 NEW agents different angle than R95(general-purpose · 設計+a11y+perf · Awwwards 2025/Stripe Press/Linear/The Pudding research + Explore · security+edge+Next.js 16 deep-bug-hunt · 0 CRITICAL 0 HIGH confirmed audit + Plan · post-R95 conversion gap audit)synthesize → 16 SHIPs identified · Wave 1 ships 7 highest-impact。 W-A · BRAND IP DEFENSE 1 · /cpbl-pitchers FounderSignOff paywall framing soften(「BLACK CARD 將來會加 engine probability column」 → 「BLACK CARD 加深的方向 = per-pitcher × per-batter probability split · engine 跑出來公開 · 同 base 排行一樣全 visible · 沒有「上面 free 下面 paywall」 dark pattern」)per Plan agent DEFENSE NOTE 1 · /integrity rule 13 engine-FREE-forever pledge surface 100% 一致。 W-B · BRAND IP DEFENSE 2 · homepage F6 strip 「不等 Q3」 → 「不自動續扣」 R81-aware fix(R30 W5 magic-link LIVE + R81 BLACK CARD season-pass LIVE · 「不等 Q3」 stale Pratfall guarantee no longer matches reality · 替換 為 /integrity rule 13 「永遠不 auto-renewal」 fresh Pratfall negation)per Plan agent DEFENSE NOTE 2。 W-C · /cpbl-pitchers W3C APG sortable-table pattern · `aria-sort=ascending|descending|none` on active <th> + `<div role=status aria-live=polite class=sr-only>` 排序 announcement(「排序依 K/9(STRIKEOUTS / 9 INNINGS)· 由高至低 · 共 16 位投手」 同 single-source)+ `scope=col` on all <th> · VoiceOver/JAWS/NVDA 0 broken-table perception · per design Agent OBSERVATION 7 + W3C APG canonical pattern。 W-D · /cpbl-pitchers The Pudding/Defector issue-numbering DATA stamp 「DATA · 2026-05-22 TPE · N=16」 top-right Geist Mono(hidden sm:block · CPBL fan cite-able snapshot · 對比 LINE 老師 never timestamp pattern)per design Agent OBSERVATION 3。 W-E · Cmd-K lib/command-palette-data.ts 4 entries 球迷 slang keywords expansion(/cpbl-pitchers + ace + control + 波球 + 勝投 + 防禦率 + 三振 + 保送 + /track-record 準不準 + 對了 + 錯了 + 命中 + Brier + /matches + 今晚 + 下午 + 比賽 + /integrity + 承諾 + 保證 + 不會變 + 永遠)power-user 搜尋 hit-rate 顯著提升 · per Plan agent SHIP 5 + audience-fans-not-engineers axiom。 W-F · NEW app/globals.css `.zh-body` utility class · CJK Typotheque + W3C CLREQ canonical(font-size 1.0625rem 17px + line-height 1.78 + max-width 38ch + text-wrap pretty + hanging-punctuation first allow-end)· apply 到 long-form Chinese prose blocks(/audit · /methodology · /year-zero · /letter · /heritage 未來)· 不 override 既有 Tailwind leading-N · 純加 default · per design Agent OBSERVATION 5。 W-G · /cpbl-pitchers team filter chip row · TEAMS const Array.from(new Set(cpblPitchers.map(p => p.team))).sort() + isTeam type guard + buildHref helper preserves stat + team across URL state + 「全部 + N teams」 chip row 上 stat tabs(球迷部落感 · 統一獅 fan 搜「統一」 looks at 統一 pitchers vs league)· N=16→ filtered ~3-4 per team · DATA stamp 加 「篩 N」 when filtered · per Plan agent SHIP 2 + audience-fans-not-engineers tribal-team axiom。 brand IP 全程 守住 · /integrity rule 13(no auto-renewal)+ Pratfall axiom + 22 binding rules + Lens Lifetime Pledge · 0 commitment 移除 · 0 binding 修改 · npm run build · 56 routes(+/cpbl-pitchers OG image)· TSC 0 · lint 0 · validate:data 0/0 · per Tim 全權 mandate。 R96 W2 next · SHIP 4 /founders <details> 5-section sm-closed collapse(3-viewport rule mobile)· R96 W3 next · SHIP 3 /cpbl-pitchers/[acnt] player drill-down SSG route(StatPercentileBar reuse · last-5-starts strip)· R96 W4 next · SHIP 6 LastShippedRail off-day Tim alive signal(lib/last-shipped.ts existing · 72h age threshold)+ design Agent OBSERVATION 1 Living Cover signature visual。",
    href: "/cpbl-pitchers",
  },
  // ── 🎯 Round 95 Wave 3+4 · 38th full-authority · SHIP A /founders R81 stale fix + duplicate cut + NEW /cpbl-pitchers route(Baseball Savant pattern · 第 1 個 power-user 互動表格)─
  {
    title: "[R95 W3+4] 🎯 38th full-authority · SHIP A /founders R81 stale references fix + FROM THE FOUNDER duplicate cut(1328→1275 · -53)+ NEW /cpbl-pitchers route(Baseball Savant Custom Leaderboards pattern · 6 stat tabs · URL-shareable sortable · 第 1 個 ZONE 27 power-user 互動表格 · 利用 existing cpblPitchers 16-投手 cache)",
    body: "Tim 38th full-authority invocation · per R95 W1+W2 同 mandate 持續 · agent SHIP A 部分 ship(highest-revenue page 需深度 plan · 先 cleanup R81 stale + 砍 clear duplicate · 大規模 section reorg defer)+ agent research SHIP 4 全 ship(Baseball Savant Custom Leaderboards pattern as Wave 4 NEW feature)。 W-A · /founders R81 stale references 4 places fix(line 56 DOLLAR_DIDNT_BUY 「BLACK CARD 月費 NT$ 299」 → 「BLACK CARD 季票 NT$ 1,500/season」 · line 69 benefits 「BLACK CARD 月費 NT$ 299」 → 「BLACK CARD 季票 NT$ 1,500/season」 · line 126-127 TIERS BLACK CARD price NT$ 299 → NT$ 1,500 · priceNote 「每月 · payment infra 就緒後上線」 → 「每季 · LIVE manual ECPay · 0 auto-renewal」 · line 185 FAQ 商業模式 「BLACK CARD 月費」 → 「BLACK CARD 季票」 · line 907 TIER COMPARISON footer 「BLACK CARD 月費為預計上線」 → 「BLACK CARD CPBL 季票 LIVE manual ECPay」 · line 973-988 WHY THIS PRICE CalcRow ANCHOR + 5-YEAR PARITY + EFFECTIVE MO. RATE 完整 R81 重算 · NT$ 17,940 5-year → NT$ 15,000 10-season · NT$ 45/月 → NT$ 2/場 5-year 1,200 games equivalent)。 W-B · FROM THE FOUNDER 段(lines 598-629 · 32 lines)cut · clear duplicate of hero founder voice block(lines 333-359)· per Agent 3 SHIP A recommendation · /founders 兩份 founder quote 是 visual stutter · 留一份 hero。 W-C · INLINE_FAQ heading 「三個您應該問的問題」 → 「您應該問的問題」 honest fix(array 實際 10 entries · 不再 lying heading · 比 cutting entries 7 to match heading 更 brand-pure per disclosure axiom)。 W-D · NEW app/cpbl-pitchers/page.tsx(330+ 行)· Baseball Savant Custom Leaderboards pattern · 6 stat tabs(K/9 · BB/9 · HR/9 · WHIP · ERA · IP · STAT_ORDER + STAT_META single-source)· URL-shareable searchParams ?stat=k9 LINE-shareable · sortable table by selected stat · per-stat fan-grammar explainer(higher-is-better arrow · range disclosure · 「越高 = 越會三振」 grammar)· cross-link 3-card grid(/matches + /lab + /methodology)· FounderSignOff 標 CPBL-only-forever per /integrity rule 12 · 利用 existing lib/cpbl-pitchers.ts 16-投手 cache(0 new data source · 0 new infra)· brand IP 「FREE forever」 binding explicit。 W-E · Cmd-K 33→34 entries 加 /cpbl-pitchers in 賽事 · 引擎 group · keyword set(cpbl pitchers + 排行 + leaderboard + 投手 + k9/bb9/hr9 + baseball savant)。 W-F · Footer FOR FANS column 加 「CPBL 投手排行 · 6 stats」 between /lab + /signal-board · discoverability · 5 → 5 (replaced position with new entry)。 Agent A research confidence HIGH ship · 「Baseball Savant Custom Leaderboards drives hardcore fan dwell time · URL-as-state means LINE-shareable · interactivity IS the dopamine · tells the fan this site treats me as someone who can read a 2D scatter」 · ZONE 27 第一個 power-user 互動表格 · CPBL-only-forever per [[zone27-coverage-philosophy]] + /integrity rule 12 · 不爬 MLB 排行 · 不接付費 API · 純 stats.cpbl.com.tw 公開 box score(per /coverage 02 ACTIVE LEAGUES + DATA PIPELINE TRANSPARENCY axiom)。 brand IP 22 binding rules 全程 active · 0 commitment 移除 · 0 binding 修改 · npm run build · 55 routes(+/cpbl-pitchers)· TSC 0 · lint 0 · validate:data 0/0 · per Tim 全權 mandate · 接續 R82-R95 14-round axis 持續到 R95 W3+4。 R95 W5+ deferred · /founders 更深 section reorg(WHY THIS PRICE 完整 move to /pricing/why · DOLLAR_DIDNT_BUY compress · NonComparable+MultiYear+Generations 3→2 collapse · INLINE_FAQ entries 4-10 polish)+ /transparency aggregator 加 /cpbl-pitchers cross-link + /cpbl-pitchers OG card NEW + 探索 weekly free post-game breakdown structure(Stratechery free flagship cadence pattern)。",
    href: "/cpbl-pitchers",
  },
