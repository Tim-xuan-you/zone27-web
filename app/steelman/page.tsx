...
const STEELMAN_OBJECTIONS: {
  ...
  // concession 物理 codify。
  {
    ...
    concession:
      "ZONE 27 不做聊天機器人、不做手機 app、不整合賠率 — 這是我們刻意的取捨 · 不是做不到 · 跟我們那串「永遠不做」的清單一致。 但「網站看起來像十年前」這個質疑很準 · 逼我們把話講死:第一年(2027-05-31)前 · 網站必須(a)做到至少 8 項現代網頁技術的基本盤 ·(b)至少加一個現代互動效果 ·(c)維持頁面載入速度與穩定度全綠。 若沒做到 · 2027 年度報告必須明寫「ZONE 27 內容紮實 · 但網站技術落後」 · 不能藏。 引擎與質感兩條腿都要顧 · 不能顧一邊丟一邊。",
  },
];
