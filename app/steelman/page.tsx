...
const STEELMAN_OBJECTIONS: {
  ...
  },
  {
    ...
    objection:
      "ZONE 27 通篇講「方法公開」 + 「我們不藏」 · 但很多獨立網站都做公開方法論。 在這個圈子裡「方法公開」是基本款 · 不是真正的護城河。 真正的護城河必須是別人結構上學不來的東西 · ZONE 27 的「方法公開」跟其他公開透明的網站太像了 · 稱不上差異化。",
    response:
      "對一半 · 要分開講。 (1) ZONE 27 要取代的不是那些本來就標榜透明的獨立網站 · 而是靠賣明牌賺錢的對手 · 在台灣棒球這塊 · 「方法公開」對他們來說仍然是學不來的護城河(他們公開等於商業自殺) ·(2) 但對更廣的讀者來說 · 透明確實是基本款 · 所以我們要講清楚「我們真正的護城河是利益不衝突 · 不是透明本身」 ·(3) 透明是必要但不夠的條件 · 真正學不來的是「靠賣明牌的生意結構上做不到的那種透明」 — 公開自我打分、公開承諾、公開帳本(連輸的預測都掛著)。",
    concession:
      "光講「方法公開」確實不夠差異化。 ZONE 27 應該把說法升級成「對手結構上做不到的那種透明」 · 而不是泛泛的透明故事。 這個質疑加速了我們把品牌講清楚。",
  },
  {
    num: "05",
    ...
    response:
      "這個質疑很狠 · 但很重要。 我們誠實回答:(1) 「承認犯錯」會加分的前提是你本來就有實力 · 不是「還沒證明就先自誇透明」 ·(2) ZONE 27 現在公開 0 付費 · 唯一說得過去的條件是 — 之後真的要做出付費會員、真的要累積結算過的預測 · 否則這套說法就垮了 ·(3) 因此我們在這裡先把話講死:第一年(2027)至少要有 10 個 BLACK 付費會員、30 場結算過的預測。 若第一年沒達標 · 2027 年度報告必須明寫「我們行銷透明 · 但沒做出真正的成績」 · 不能藏 ·(4) 2026 年度報告也要先公開這組第一年標準。",
    concession:
  ...
  // concession 物理 codify。
  {
    ...
    objection:
      "現在很多 app 推出「AI 看球」 — 賽前賽後 AI 簡報 + 聊天機器人隨問隨答 + 相機認球員 + AI 生成球場圖片 · 還整合即時賠率預測勝負 · 全部塞在一個手機 app 裡。 用講話就能問、邊看邊問、很順。 ZONE 27 只做一個靜態網站 · 7 個固定鏡頭 · 沒有聊天機器人、沒有自然語言問答、沒有相機、沒有圖片生成、沒有手機 app、沒有賠率整合。 在大家都搶注意力、又是手機優先的年代 · ZONE 27 看起來像個十年前的網站。 「方法公開」這個賣點 · 對比「用 AI 包成自然對話」 · 多數球迷會選後者。 五年內 AI 看球助手變成標配 · ZONE 27 會像個學術展品 · 不像個活著的產品。",
    response:
    ...
    concession:
      "ZONE 27 不做聊天機器人、不做手機 app、不整合賠率 — 這是我們刻意的取捨 · 不是做不到 · 跟我們那串「永遠不做」的清單一致。 但「網站看起來像十年前」這個質疑很準 · 逼我們把話講死:第一年(2027-05-31)前 · 網站必須(a)做到至少 8 項現代網頁技術的基本盤 ·(b)至少加一個現代互動效果 ·(c)維持頁面載入速度與穩定度都達標。 若沒做到 · 2027 年度報告必須明寫「ZONE 27 內容紮實 · 但網站技術落後」 · 不能藏。 引擎與質感兩條腿都要顧 · 不能顧一邊丟一邊。",
  },
];
      ...
      <main id="main">
        ...
        <section className="mx-auto max-w-3xl w-full px-6 sm:px-10 pb-16 border-t border-line/40 pt-12">
          ...
          <div className="border border-gold/40 bg-slate/40 p-5 sm:p-7 glow-soft">
            ...
            <p className="mt-5 font-mono text-mute/80 text-sm tracking-[0.18em] leading-relaxed">
              ⚓ 若第一年(2027-05-31)沒達到上述最低標準 · 2027
        ...
        <section className="mx-auto max-w-3xl w-full px-6 sm:px-10 py-16 text-center border-t border-line/40">
          ...
          {/* Round 51 W-C · Agent 3 HIGH #6 fix · /steelman conversion CTA
              ...
              trust loop must close to BLACK entry。
              (GOLD/founder 付費層已收掉 · 只剩單一 BLACK · 連 /membership) */}
