...
export const metadata: Metadata = {
  ...
  description:
    "ZONE 27 自己寫出反對我們最強的 6 個論點 · 自己當反方 · 把你最可能拿來質疑我們的話先講出來。玩運彩、報馬仔永遠不會公開反對自己的論證,因為他們的每一條質疑都同時是他們的訃聞。",
};
...
const STEELMAN_OBJECTIONS: {
  ...
  },
  {
    ...
    response:
      "對一半 · 要分開講。 (1) ZONE 27 要取代的不是那些本來就標榜透明的獨立網站 · 而是玩運彩和報馬仔 · 在台灣棒球這塊 · 「方法公開」對他們來說仍然是學不來的護城河(他們公開等於商業自殺) ·(2) 但對更廣的讀者來說 · 透明確實是基本款 · 所以我們要講清楚「我們真正的護城河是利益不衝突 · 不是透明本身」 ·(3) 透明是必要但不夠的條件 · 真正學不來的是「玩運彩結構上做不到的那種透明」 — 公開自我打分、公開承諾、公開抽成帳本。",
    concession:
      ...
      <main id="main">
        ...
        <section className="mx-auto max-w-3xl w-full px-6 sm:px-10 pb-16 border-t border-line/40 pt-12">
          ...
          <div className="space-y-4 text-mute leading-relaxed">
            ...
            <p>
              <strong className="text-bone">為什麼玩運彩、報馬仔做不到這頁</strong> ·
        ...
        <FounderSignOff>
          ...
          <p>
            多數網站自己當銷售 · ZONE 27 自己當批評者。 玩運彩、報馬仔
            永遠做不出同樣一頁 · 因為他們最強的反對論點同時就是他們的訃聞。
          </p>
          <p>
