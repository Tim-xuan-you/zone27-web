...
const MILESTONES: { date: string; title: string; detail: string }[] = [
  ...
  },
  {
    ...
    detail:
      "四根支柱:引擎永遠免費、群眾即時預測市場(虛擬點數・零真錢)、創作者標價賣分析平台抽 5–10%、準度海選天梯。會員不限量,前 270 名拿永久創始編號。",
  },
  {
    date: "2026-05-26",
    title: "大幅減頁・學 Apple",
  ...
  },
  {
    ...
    detail:
      "打造 ZONE 27 品牌系統、逐打席 Monte Carlo 模擬引擎、/lab 模擬器、整合 MLB 官方資料。完整逐版歷史見 GitHub commits。",
  },
];
