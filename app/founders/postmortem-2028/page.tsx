...
const SCENARIOS: Scenario[] = [
  {
    ...
    narrative:
      "我在 2027 Q2 開始出貨速度減半。 FOUNDER 的 270 人都已經加入 · 但每週要寫工程筆記、回訊息、處理 CPBL 資料、維護準度報告 · 一個人全包扛不住。 一開始我以為再撐一下就好。 接著我開始略過某幾週的工程筆記 · 然後回訊息從 24 小時變 72 小時變一週。 BLACK 訂戶看到品質下降 · 下一季就不續訂了。 2027 Q4 · 我才發現「能不能持續維持速度」是這個模式藏起來的死穴 · 不是可有可無的事。",
    signal:
