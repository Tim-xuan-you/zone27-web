...
const SCENARIOS: Scenario[] = [
  {
    ...
    narrative:
      "我在 2027 Q2 開始出貨速度減半。 GOLD 會員一個個加入 · 但每週要寫工程筆記、回訊息、處理 CPBL 資料、維護準度報告 · 一個人全包扛不住。 一開始我以為再撐一下就好。 接著我開始略過某幾週的工程筆記 · 然後回訊息從 24 小時變 72 小時變一週。 BLACK 訂戶看到品質下降 · 下一季就不續訂了。 2027 Q4 · 我才發現「能不能持續維持速度」是這個模式藏起來的死穴 · 不是可有可無的事。",
    signal:
      "WATCHING · 每週工程筆記延遲 3 天以上 · 回訊息的中位時間超過 48 小時 · 進度日誌連續 2 週沒更新。",
    canary:
      "FIRE IF · 2026-12-31 前任一指標觸發 · 立即公開一封「調整更新節奏」的信 · 暫停 GOLD 新申請 · 重新評估我一個人能負荷的量。",
  },
  {
    no: "02",
    enKicker: "REVENUE BRIDGE GAP",
    zhTitle: "GOLD 賣完 · 光靠 BLACK NT$ 500/31 天 養不起一個人的工程進度",
    narrative:
      "GOLD 的 270 席在 2027 Q1 賣完 · 年度收入 NT$ 729,000 入帳。 我以為這就打平了。 結果 BLACK NT$ 500/31 天 的轉換率比預期低 · 一年大約 12 期 × 100 訂戶 ≈ NT$ 600,000/年 · 一個人扛工程 + CPBL 數據 + 客服的成本超過收入 · 2027 年底我發現自己在補貼 · 不是在維持。 「引擎永遠免費」是不能破的原則 · 不能拿引擎收費。 我只剩三個選擇:(a)放棄全職、兼差維持 · 但出貨速度掉到三分之一 ·(b)增加 GOLD 名額 · 但這破壞了原本的稀缺承諾 ·(c)加付費功能 · 但訂閱本來就該是支持、不是把功能鎖起來。 三個都傷品牌。",
    signal:
      "WATCHING · 2027 Q2 有效 BLACK 訂戶低於 80 · 接下來半年的花費超過半年的存糧 · 到 2027-06-30 GOLD 賣出不到 200。",
    canary:
      "FIRE IF · 2027-06-30 BLACK 不到 80 且 GOLD 不到 200 · 立即在 /founders/ledger 公開一封財務誠實信 · 邀請 GOLD 票選 4 個維持下去的方案 · 不偷偷轉向。",
  },
  {
    no: "03",
  ...
  },
  {
    ...
    narrative:
      "2026 Q4 · 因為 GOLD 轉換比預期慢 · 我慌了、提早衝行銷。 上了網站地圖、開放搜尋引擎、註冊社群帳號、寫了上線文。 結果第一波流量在還沒準備好的狀態下湧進來。 訪客看到的是只有 15 場的準度樣本、還是舊版引擎、0 筆真實付費紀錄 · 半成品的印象就這樣烙進腦海。 之後真的做出成熟版本 · 但第一印象已經定型 · 定位被打壞了。 我自己破了「域名與行銷等時機成熟再動」的原則 · 跟之前那些「明天再做」的拖延承諾、以及自打嘴巴的功能一樣 · 都是我自己埋的坑自己跳。",
    signal:
