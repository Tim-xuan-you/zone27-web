...
//   - NT$ 1,500 / season + 5% 創作者抽成(vs 業界 30-50% 是降維打擊)
...
export const alt =
  "ZONE 27 · BLACK CARD · 訂閱會員 UI preview · NT$ 1,500/season · PRE-LAUNCH milestone-triggered · 6 unlocks · 5% 創作者抽成";
    ...
    (
      ...
      >
        ...
        >
          ...
          >
            訂閱會員 · 6 unlocks · 5% 創作者抽成(vs 業界 30-50%)
          </span>
        </div>
